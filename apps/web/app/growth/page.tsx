  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#0b0b0b] text-neutral-100">
      ...
      <main className="flex-grow max-w-6xl w-full mx-auto p-6 flex flex-col gap-8">
        ...
        {/* Top Analytics KPI Row (2x2 on mobile, 4 cols on desktop) */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <div className="bg-[#121212] border border-neutral-800 p-4 sm:p-5 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 shadow-xl">
            <div className="p-2.5 sm:p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl text-amber-400">
              <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <span className="text-[9px] sm:text-[10px] font-bold text-neutral-400 uppercase tracking-wider block">BKT Mastery</span>
              <span className="text-lg sm:text-xl font-black font-mono text-white mt-0.5">{masteryPercentage}%</span>
            </div>
          </div>

          <div className="bg-[#121212] border border-neutral-800 p-4 sm:p-5 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 shadow-xl">
            <div className="p-2.5 sm:p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-emerald-400">
              <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <span className="text-[9px] sm:text-[10px] font-bold text-neutral-400 uppercase tracking-wider block">Score</span>
              <span className="text-lg sm:text-xl font-black font-mono text-white mt-0.5">{sessionScore} pts</span>
            </div>
          </div>

          <div className="bg-[#121212] border border-neutral-800 p-4 sm:p-5 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 shadow-xl">
            <div className="p-2.5 sm:p-3 bg-indigo-500/10 border border-indigo-500/30 rounded-xl text-indigo-400">
              <Layers className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <span className="text-[9px] sm:text-[10px] font-bold text-neutral-400 uppercase tracking-wider block">IRT Theta (θ)</span>
              <span className="text-lg sm:text-xl font-black font-mono text-white mt-0.5">{thetaDelta.toFixed(3)}</span>
            </div>
          </div>

          <div className="bg-[#121212] border border-neutral-800 p-4 sm:p-5 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 shadow-xl">
            <div className="p-2.5 sm:p-3 bg-purple-500/10 border border-purple-500/30 rounded-xl text-purple-400">
              <Clock className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <span className="text-[9px] sm:text-[10px] font-bold text-neutral-400 uppercase tracking-wider block">Velocity</span>
              <span className="text-lg sm:text-xl font-black font-mono text-white mt-0.5">48.2s</span>
            </div>
          </div>
        </div>

        {/* 4-Quadrant Metacognitive Calibration Matrix (Research Model) */}
        <div className="bg-[#121212] border border-neutral-800 rounded-3xl p-5 sm:p-6 shadow-xl flex flex-col gap-5">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-neutral-800 pb-4">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <span className="px-2.5 py-1 bg-purple-500/10 border border-purple-500/30 text-purple-300 text-xs font-mono rounded-lg">
                ECE: 0.048 (Calibrated)
              </span>
              <span className="px-2.5 py-1 bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs font-mono rounded-lg">
                Brier: 0.078
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-4 bg-emerald-500/5 border border-emerald-500/30 rounded-2xl flex flex-col justify-between gap-3">
              <div className="flex flex-wrap items-center justify-between gap-1">
                <span className="text-[9px] font-extrabold uppercase px-2 py-0.5 bg-emerald-500/20 text-emerald-300 rounded border border-emerald-500/40">
                  Quadrant I • Mastered
                </span>
            ...
            <div className="p-4 bg-blue-500/5 border border-blue-500/30 rounded-2xl flex flex-col justify-between gap-3">
              <div className="flex flex-wrap items-center justify-between gap-1">
                <span className="text-[9px] font-extrabold uppercase px-2 py-0.5 bg-blue-500/20 text-blue-300 rounded border border-blue-500/40">
            ...
            <div className="p-4 bg-rose-500/5 border border-rose-500/40 rounded-2xl flex flex-col justify-between gap-3">
              <div className="flex flex-wrap items-center justify-between gap-1">
                <span className="text-[9px] font-extrabold uppercase px-2 py-0.5 bg-rose-500/20 text-rose-300 rounded border border-rose-500/40 animate-pulse">
            ...
            <div className="p-4 bg-amber-500/5 border border-amber-500/30 rounded-2xl flex flex-col justify-between gap-3">
              <div className="flex flex-wrap items-center justify-between gap-1">
                <span className="text-[9px] font-extrabold uppercase px-2 py-0.5 bg-amber-500/20 text-amber-300 rounded border border-amber-500/40">
